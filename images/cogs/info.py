...
class Info(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        embed.add_field(name="• System:", value=f'`{uname.system}`')
        embed.add_field(name="• System Version", value=f'`{uname.version}`')
        embed.add_field(name="• Machine:", value=f'`{uname.machine}`')
        embed.add_field(name="• Processor:", value=f'`{uname.processor}`')
        embed.add_field(name="• Total CPU Usage:", value=f'`{psutil.cpu_percent()}`')
        embed.add_field(name="• Total RAM:", value=f'`{psutil.virtual_memory()[2]}`')
        embed.add_field(name="• Total Space:", value=f'`{obj_Disk.total / (1024.0 ** 3)}`')
        embed.add_field(name="• Total Spaced Used:", value=f'`{obj_Disk.used / (1024.0 ** 3)}`')
        embed.add_field(name="• Total Space Left:", value=f'`{obj_Disk.free / (1024.0 ** 3)}`')
